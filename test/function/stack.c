...
( void )
{
  Stack * result = PushToStack( NULL, "this" );
...
( void )
{
  ...
  unsigned previous_capacity = stack->capacity;
  unsigned i;
  ...
  Stack * result = PushToStack( stack, "last straw" );
  if( result != stack )
