...
"संदेश को स्टोर करने के लिए उपयोग किया जाने वाला बफर"

#  define L10N_BUFFER_TOO_SMALL_ERROR_MESSAGE \
"दिए गए संदेश के लिए बफ़र बहुत छोटा है"

#  define L10N_CHAIN_TARGETS_UNSUPPORTED \
"इस बिल्ड द्वारा चेन टारगेट्स (chain targets) समर्थित नहीं हैं"
...
"स्ट्रिंग name=\"value\" प्रारूप में नहीं है"
...
"UTF-8 स्ट्रिंग पार्सिंग के दौरान अमान्य स्थिति (invalid state) तक पहुंच गया"
...
"gethostbyname[2] और inet_pton नाम को रिज़ॉल करने में विफल रहे"
...
"तीव्रता के रंग (severity colors) केवल स्ट्रीम टारगेट्स के लिए समर्थित हैं"
...
PARAM " को स्टेटमेंट से बाइंड (bind) नहीं किया जा सका"

#  define L10N_SQLITE3_BUSY_ERROR_MESSAGE \
"डेटाबेस व्यस्त था और लेनदेन (transaction) पूरा नहीं कर सका"
...
"तैयार स्टेटमेंट्स (prepared statements) के लिए एक कस्टम कॉलबैक विफल रहा"

#  define L10N_SQLITE3_OPEN_FAILED_ERROR_MESSAGE \
"sqlite3 डेटाबेस को नहीं खोला जा सका"

#  define L10N_SQLITE3_PREPARE_FAILED_ERROR_MESSAGE \
"sqlite3_prepare_v2 विफल रहा"

#  define L10N_SQLITE3_RESULT_CODE_TYPE \
"विफल sqlite3 कॉल का रिटर्न कोड"

#  define L10N_SQLITE3_RETRY_COUNT_CODE_TYPE \
"ऑपरेशन को कितनी बार फिर से प्रयास (retry) किया गया"

#  define L10N_SQLITE3_STEP_FAILED_ERROR_MESSAGE \
"sqlite3_step विफल रहा"

#  define L10N_SQLITE3_TARGETS_UNSUPPORTED \
"इस बिल्ड द्वारा sqlite3 टारगेट्स समर्थित नहीं हैं"
