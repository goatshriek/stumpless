...
#    define config_close_tcp6_target sys_socket_close_tcp6_target
#    define config_close_udp4_target sys_socket_close_udp4_target
#    define config_close_udp6_target sys_socket_close_udp6_target
#    define config_init_tcp4 sys_socket_init_tcp4
#    define config_init_tcp6 sys_socket_init_tcp6
#    define config_init_udp4 sys_socket_init_udp4
#    define config_init_udp6 sys_socket_init_udp6
...
#    define config_sendto_tcp6_target sys_socket_sendto_tcp6_target
#    define config_sendto_udp4_target sys_socket_sendto_udp4_target
#    define config_sendto_udp6_target sys_socket_sendto_udp6_target
#    define config_set_tcp4_port sys_socket_set_tcp4_port
#    define config_set_tcp6_port sys_socket_set_tcp6_port
#    define config_set_udp4_port sys_socket_set_udp4_port
#    define config_set_udp6_port sys_socket_set_udp6_port
#    define config_tcp4_is_open sys_socket_tcp4_is_open
#    define config_tcp6_is_open sys_socket_tcp6_is_open
#    define config_udp4_is_open sys_socket_udp4_is_open
#    define config_udp6_is_open sys_socket_udp6_is_open
#  elif HAVE_WINSOCK2_H
#    include "private/config/have_winsock2.h"
#    define config_close_tcp4_target winsock2_close_tcp4_target
#    define config_close_tcp6_target winsock2_close_tcp6_target
#    define config_close_udp4_target winsock2_close_udp4_target
#    define config_close_udp6_target winsock2_close_udp6_target
#    define config_init_tcp4 winsock2_init_tcp4
#    define config_init_tcp6 winsock2_init_tcp6
#    define config_init_udp4 winsock2_init_udp4
#    define config_init_udp6 winsock2_init_udp6
...
#    define config_sendto_tcp6_target winsock2_sendto_tcp6_target
#    define config_sendto_udp4_target winsock2_sendto_udp4_target
#    define config_sendto_udp6_target winsock2_sendto_udp6_target
#    define config_set_tcp4_port winsock2_set_tcp4_port
#    define config_set_tcp6_port winsock2_set_tcp6_port
#    define config_set_udp4_port winsock2_set_udp4_port
#    define config_set_udp6_port winsock2_set_udp6_port
#    define config_tcp4_is_open winsock2_tcp4_is_open
#    define config_tcp6_is_open winsock2_tcp6_is_open
#    define config_udp4_is_open winsock2_udp4_is_open
#    define config_udp6_is_open winsock2_udp6_is_open
#  endif
