...
my %manifest = (
  ...
  "config_close_wel_target" => "private/config/wrapper.h",
  ...
  "FAIL" => "gtest/gtest.h",
  "file_open_default_target" => "private/target/file.h",
  ...
  "MAX_INT_SIZE" => "private/inthelper.h",
  ...
  "no_vsnprintf_s_format_string" => "private/config/no_vsnprintf_s.h",
  ...
  "raise_index_out_of_bounds" => "private/error.h",
  ...
  "socket_open_default_target" => "private/config/socket_supported.h",
  ...
  "strbuilder_to_string" => "private/strbuilder.h",
  ...
  "stumpless_get_default_target" => "stumpless/target.h",
  ...
  "stumpless_get_wel_insertion_string" => "stumpless/config/wel_supported.h",
  "stumpless_id_t" => "stumpless/id.h",
  "STUMPLESS_INDEX_OUT_OF_BOUNDS" => "stumpless/error.h",
  ...
  "stumpless_set_wel_insertion_string" => "stumpless/config/wel_supported.h",
  "stumpless_set_wel_insertion_strings" => "stumpless/config/wel_supported.h",
  ...
  "vsnprintf_s_format_string" => "private/config/have_vsnprintf_s.h",
  "vstumpless" => "stumpless/target.h",
  "vstumpless_add_log" => "stumpless/target.h",
  "vstumpless_add_message" => "stumpless/target.h",
  "vstumpless_new_entry" => "stumpless/entry.h",
  "vstumpless_set_entry_message" => "stumpless/entry.h",
  "vstumpless_set_wel_insertion_strings" => "stumpless/config/wel_supported.h",
  "vstumplog" => "stumpless/target.h",
  "wel_open_default_target" => "private/config/wel_supported.h",
